...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        foutC << estimator.Ps[WINDOW_SIZE].x() << ","
              ...
              << estimator.angular_velocity_buf[WINDOW_SIZE-1].back().x() - estimator.Bgs[WINDOW_SIZE].x()<< ","
              << estimator.angular_velocity_buf[WINDOW_SIZE-1].back().y() - estimator.Bgs[WINDOW_SIZE].y() << ","
              << estimator.angular_velocity_buf[WINDOW_SIZE-1].back().z() - estimator.Bgs[WINDOW_SIZE].z()<< ","
